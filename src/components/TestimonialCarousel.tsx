      ...
      <CarouselContent>
        {testimonials.map((testimonial, index) => (
          <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
            <div className="p-1">
              <Card className="border-2 hover:shadow-glow transition-all duration-300 h-full bg-gradient-to-br from-card to-card/50">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-vibrant flex items-center justify-center text-2xl">
                      {testimonial.image}
                    </div>
                    <div>
